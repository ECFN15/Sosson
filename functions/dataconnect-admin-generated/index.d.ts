...
/** Generated Node Admin SDK operation action function for the 'CreatePrevisionnelWorkbookVersionPending' Mutation. Allow users to execute without passing in DataConnect. */
export function createPrevisionnelWorkbookVersionPending(dc: DataConnect, vars: CreatePrevisionnelWorkbookVersionPendingVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<CreatePrevisionnelWorkbookVersionPendingData>>;
/** Generated Node Admin SDK operation action function for the 'CreatePrevisionnelWorkbookVersionPending' Mutation. Allow users to pass in custom DataConnect instances. */
export function createPrevisionnelWorkbookVersionPending(vars: CreatePrevisionnelWorkbookVersionPendingVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<CreatePrevisionnelWorkbookVersionPendingData>>;

/** Generated Node Admin SDK operation action function for the 'MarkPrevisionnelWorkbookVersionGenerating' Mutation. Allow users to execute without passing in DataConnect. */
export function markPrevisionnelWorkbookVersionGenerating(dc: DataConnect, vars: MarkPrevisionnelWorkbookVersionGeneratingVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<MarkPrevisionnelWorkbookVersionGeneratingData>>;
/** Generated Node Admin SDK operation action function for the 'MarkPrevisionnelWorkbookVersionGenerating' Mutation. Allow users to pass in custom DataConnect instances. */
export function markPrevisionnelWorkbookVersionGenerating(vars: MarkPrevisionnelWorkbookVersionGeneratingVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<MarkPrevisionnelWorkbookVersionGeneratingData>>;

/** Generated Node Admin SDK operation action function for the 'MarkPrevisionnelWorkbookVersionGenerated' Mutation. Allow users to execute without passing in DataConnect. */
export function markPrevisionnelWorkbookVersionGenerated(dc: DataConnect, vars: MarkPrevisionnelWorkbookVersionGeneratedVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<MarkPrevisionnelWorkbookVersionGeneratedData>>;
/** Generated Node Admin SDK operation action function for the 'MarkPrevisionnelWorkbookVersionGenerated' Mutation. Allow users to pass in custom DataConnect instances. */
export function markPrevisionnelWorkbookVersionGenerated(vars: MarkPrevisionnelWorkbookVersionGeneratedVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<MarkPrevisionnelWorkbookVersionGeneratedData>>;

/** Generated Node Admin SDK operation action function for the 'MarkPrevisionnelWorkbookVersionFailed' Mutation. Allow users to execute without passing in DataConnect. */
export function markPrevisionnelWorkbookVersionFailed(dc: DataConnect, vars: MarkPrevisionnelWorkbookVersionFailedVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<MarkPrevisionnelWorkbookVersionFailedData>>;
/** Generated Node Admin SDK operation action function for the 'MarkPrevisionnelWorkbookVersionFailed' Mutation. Allow users to pass in custom DataConnect instances. */
export function markPrevisionnelWorkbookVersionFailed(vars: MarkPrevisionnelWorkbookVersionFailedVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<MarkPrevisionnelWorkbookVersionFailedData>>;
...
/** Generated Node Admin SDK operation action function for the 'GetPrevisionnelWorkbookVersion' Query. Allow users to execute without passing in DataConnect. */
export function getPrevisionnelWorkbookVersion(dc: DataConnect, vars: GetPrevisionnelWorkbookVersionVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<GetPrevisionnelWorkbookVersionData>>;
/** Generated Node Admin SDK operation action function for the 'GetPrevisionnelWorkbookVersion' Query. Allow users to pass in custom DataConnect instances. */
export function getPrevisionnelWorkbookVersion(vars: GetPrevisionnelWorkbookVersionVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<GetPrevisionnelWorkbookVersionData>>;

/** Generated Node Admin SDK operation action function for the 'ListPrevisionnelWorkbookVersions' Query. Allow users to execute without passing in DataConnect. */
export function listPrevisionnelWorkbookVersions(dc: DataConnect, vars: ListPrevisionnelWorkbookVersionsVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<ListPrevisionnelWorkbookVersionsData>>;
/** Generated Node Admin SDK operation action function for the 'ListPrevisionnelWorkbookVersions' Query. Allow users to pass in custom DataConnect instances. */
export function listPrevisionnelWorkbookVersions(vars: ListPrevisionnelWorkbookVersionsVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<ListPrevisionnelWorkbookVersionsData>>;

/** Generated Node Admin SDK operation action function for the 'GetLatestGeneratedPrevisionnelWorkbookVersion' Query. Allow users to execute without passing in DataConnect. */
export function getLatestGeneratedPrevisionnelWorkbookVersion(dc: DataConnect, vars: GetLatestGeneratedPrevisionnelWorkbookVersionVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<GetLatestGeneratedPrevisionnelWorkbookVersionData>>;
/** Generated Node Admin SDK operation action function for the 'GetLatestGeneratedPrevisionnelWorkbookVersion' Query. Allow users to pass in custom DataConnect instances. */
export function getLatestGeneratedPrevisionnelWorkbookVersion(vars: GetLatestGeneratedPrevisionnelWorkbookVersionVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<GetLatestGeneratedPrevisionnelWorkbookVersionData>>;
